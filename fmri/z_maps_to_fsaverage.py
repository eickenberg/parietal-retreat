...
def project_z_map(in_file, subject, hemi, proj_frac, fsaverage_fwhm=3.):
    ...
    out_data = project_z_maps(in_file, hemi, subject_id=subject,
                              projmeth="frac", projarg=projfrac)
    out_data_avg = project_z_maps(in_file, hemi, subject_id=subject,
                                  proj_meth="frac", projarg=projfrac,
                                  target_subject="fs_average",
